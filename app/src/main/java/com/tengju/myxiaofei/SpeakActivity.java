...
public class SpeakActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private void initLayout() {
        findViewById(R.id.tts_play).setOnClickListener(SpeakActivity.this);
        findViewById(R.id.tts_cancel).setOnClickListener(SpeakActivity.this);
        findViewById(R.id.tts_pause).setOnClickListener(SpeakActivity.this);
        findViewById(R.id.tts_resume).setOnClickListener(SpeakActivity.this);
        findViewById(R.id.image_tts_set).setOnClickListener(SpeakActivity.this);
        findViewById(R.id.tts_btn_person_select).setOnClickListener(SpeakActivity.this);
        ...
        switch(view.getId()) {
            case R.id.image_tts_set:
                if(SpeechConstant.TYPE_CLOUD.equals(mEngineType)){
                    Intent intent = new Intent(SpeakActivity.this, TtsSettings.class);
